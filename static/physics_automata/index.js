...
function findWasmBinary() {
    return locateFile('physics_automata.wasm');
}
...
var ASM_CONSTS = {
  94408: () => { if (document.fullscreenElement) return 1; },  
 94454: () => { return Module.canvas.width; },  
 94486: () => { return parseInt(Module.canvas.style.width); },  
 94534: () => { document.exitFullscreen(); },  
 94561: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94634: () => { if (document.fullscreenElement) return 1; },  
 94680: () => { return Module.canvas.width; },  
 94712: () => { return screen.width; },  
 94737: () => { document.exitFullscreen(); },  
 94764: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94897: () => { return window.innerWidth; },  
 94923: () => { return window.innerHeight; },  
 94950: () => { if (document.fullscreenElement) return 1; },  
 94996: () => { return Module.canvas.width; },  
 95028: () => { return parseInt(Module.canvas.style.width); },  
 95076: () => { if (document.fullscreenElement) return 1; },  
 95122: () => { return Module.canvas.width; },  
 95154: () => { return screen.width; },  
 95179: () => { return window.innerWidth; },  
 95205: () => { return window.innerHeight; },  
 95232: () => { if (document.fullscreenElement) return 1; },  
 95278: () => { return Module.canvas.width; },  
 95310: () => { return screen.width; },  
 95335: () => { document.exitFullscreen(); },  
 95362: () => { if (document.fullscreenElement) return 1; },  
 95408: () => { return Module.canvas.width; },  
 95440: () => { return parseInt(Module.canvas.style.width); },  
 95488: () => { document.exitFullscreen(); },  
 95515: ($0) => { Module.canvas.style.opacity = $0; },  
 95553: () => { return screen.width; },  
 95578: () => { return screen.height; },  
 95604: () => { return window.screenX; },  
 95631: () => { return window.screenY; },  
 95658: () => { return window.devicePixelRatio; },  
 95694: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95747: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95798: () => { Module.canvas.style.cursor = 'none'; },  
 95835: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96091: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96142: () => { if (document.fullscreenElement) return 1; },  
 96188: () => { return window.innerWidth; },  
 96214: () => { return window.innerHeight; },  
 96241: () => { if (document.pointerLockElement) return 1; }
};
